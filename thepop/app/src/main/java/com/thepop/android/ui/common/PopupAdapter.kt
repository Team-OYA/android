...
import com.thepop.android.databinding.RvPopUpBinding

class PopupAdapter(private val popupList: PopupListResponse.PopupList):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopupViewHolder {
        val binding = RvPopUpBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class PopupViewHolder(private val binding: RvPopUpBinding): RecyclerView.ViewHolder(binding.root) {
